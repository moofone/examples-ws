//! Lightweight, allocation-free candle aggregation primitives.
//!
//! This module is intended for tight loops (e.g., websocket ingress decoders) where you want to
//! process every event but only emit compact updates when "interesting" thresholds are crossed.
